Attribute VB_Name = "ModMakeResident"
Option Explicit

'This module contains a subroutine "MakeResident" that receives
'a filepath and make that file to be execute everytime the windows
'start with a new technology (ActiveX components)
'Add the module to your project and call the function "Makeresident"
'with your EXE path at your STARTUP form (or Sub Main())
'*** IMPORTANT : Your App must call this function everytime it runs.
'EXAMPLE:       Makeresident "C:\Program Files\MyApp.exe"

'Code by Dr. Y          mosibatzadeh@yahoo.com
